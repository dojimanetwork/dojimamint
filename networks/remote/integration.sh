...
# **turn on the go module, default is auto. The value is off, if dojimamint source code
#is downloaded under $GOPATH/src directory
echo "export GO111MODULE=on" >> ~/.profile

source ~/.profile

mkdir -p $GOPATH/src/github.com/dojimamint
cd $GOPATH/src/github.com/dojimamint
...
cd $GOPATH/src/github.com/dojimamint/dojimamint/networks/remote/terraform
...
cd $GOPATH/src/github.com/dojimamint/dojimamint/networks/remote/ansible

# create config dirs
dojimamint testnet

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/dojimamint/dojimamint/build/dojimamint -e CONFIGDIR=$GOPATH/src/github.com/dojimamint/dojimamint/networks/remote/ansible/mytestnet
...
old_ansible_file=$GOPATH/src/github.com/dojimamint/dojimamint/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file

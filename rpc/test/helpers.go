...
// StartTendermint starts a test dojimamint server in a go routine and returns when it is initialized
...
// StopTendermint stops a test dojimamint server, waits until it's stopped and
...
// NewTendermint creates a new dojimamint server and sleeps forever

...
func (h *Handshaker) ReplayBlocks(
	...
	case storeBlockHeight < stateBlockHeight:
		// the state should never be ahead of the store (this is under dojimamint's control)
	...
	case storeBlockHeight > stateBlockHeight+1:
		// store should be at most one ahead of the state (this is under dojimamint's control)
